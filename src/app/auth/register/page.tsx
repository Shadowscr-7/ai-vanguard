  ...
  return (
    <div className="modal-overlay active" style={{ position: "relative", minHeight: "100vh" }}>
      ...
      <div className="pointer-events-none fixed inset-0">
        <div className="absolute left-1/3 top-1/4 h-96 w-96 rounded-full bg-accent-purple/8 blur-[120px]" />
        <div className="absolute bottom-1/4 right-1/3 h-96 w-96 rounded-full bg-accent-cyan/8 blur-[120px]" />
      </div>
      ...
      <div className="modal-container">
        ...
        <div className="modal-header" style={{ textAlign: "center" }}>
          <h2>Crear Cuenta</h2>
          <p>Regístrate para acceder a cursos y libros</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="input-group">
            ...
            {password.length > 0 && (
              <div style={{ marginTop: "8px", display: "flex", alignItems: "center", gap: "6px", fontSize: "0.8rem" }}>
                {passwordValid ? (
                  <>
                    <CheckCircle size={14} style={{ color: "var(--accent-green)" }} />
                    <span style={{ color: "var(--accent-green)" }}>Contraseña válida</span>
                  </>
                ) : (
                  <>
